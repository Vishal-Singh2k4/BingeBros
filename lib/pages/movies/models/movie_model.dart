  ...
  factory Movie.fromJson(Map<String, dynamic> json) {
    ...
    return Movie(
      ...
      releaseDate: json['release_date'] as String? ??
          'Unknown', // Provide default value for releaseDate
      overview: json['overview'] as String? ??
          'No overview available', // Provide default value for overview
      genres: genreList
          .map((genreJson) => Genre.fromJson(genreJson as Map<String, dynamic>))
          .toList(), // Ensure correct type casting
      voteAverage: (json['vote_average'] as num?)?.toDouble() ??
          0.0, // Safely parse voteAverage
    );
  }
